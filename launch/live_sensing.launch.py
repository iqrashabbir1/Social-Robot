...
def generate_launch_description() -> LaunchDescription:
    default_config = PathJoinSubstitution([FindPackageShare("social_robot"), "config", "live_sensing.yaml"])
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("output_dir", default_value="outputs/logs/ros2_live_sensing"),
