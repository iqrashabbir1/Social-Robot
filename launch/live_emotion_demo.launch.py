...
def generate_launch_description() -> LaunchDescription:
    default_config = PathJoinSubstitution([FindPackageShare("social_robot"), "config", "live_emotion_demo.yaml"])
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("output_dir", default_value="outputs/logs/ros2_live_emotion_demo"),
